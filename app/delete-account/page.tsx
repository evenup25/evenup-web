      ...
      <main>
        <section className="px-5 py-14 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-start">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.14em] text-[var(--color-danger)]">
                Account deletion
              </p>
              <h1 className="mt-3 max-w-3xl font-display text-4xl font-black leading-tight text-[var(--color-text-primary)] sm:text-5xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--color-danger)] px-6 py-3 text-sm font-extrabold text-white shadow-[0_16px_32px_rgba(255,71,87,0.2)] transition hover:opacity-90">
                  Request by email
            ...
            <aside className="rounded-[28px] border border-[rgba(255,176,32,0.35)] bg-[rgba(255,176,32,0.1)] p-6">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white text-[var(--color-warning)]">
            ...
            <div className="mt-7 grid gap-4 md:grid-cols-2">
              {steps.map((step, index) => (
                <article
                  ...
                  <div className="flex items-start gap-4">
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[rgba(43,127,255,0.12)] font-display font-black text-[var(--color-action-primary)]">
                      {index + 1}
                    </span>
                    <div>
        ...
        <section className="px-5 py-14 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-5xl gap-5 md:grid-cols-2">
            <article className="rounded-[28px] border border-[var(--color-border-subtle)] bg-white p-6 shadow-sm">
        ...
        <section className="bg-white px-5 py-14 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl rounded-[28px] border border-[var(--color-border-subtle)] bg-[var(--color-bg-surface-alt)] p-6 sm:p-8">
